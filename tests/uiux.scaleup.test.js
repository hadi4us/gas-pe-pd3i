...
test('shared spacing contract keeps cards and frames separated across pages', () => {
  ...
  assert.match(styleHtml, /\.pd3i-workspace-section\{gap:24px\}/);
  assert.match(styleHtml, /\.pd3i-shell-card\+\.pd3i-shell-card,\.pd3i-card\+\.pd3i-card,\.pd3i-form-card-section\+\.pd3i-form-card-section\{margin-top:24px\}/);
  ...
  assert.match(styleHtml, /@media\(max-width:700px\)[\s\S]*\.pd3i-workspace-section[\s\S]*gap:18px/);
});
