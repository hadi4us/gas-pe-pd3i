...
test('PIE checkbox cards keep equal responsive dimensions', () => {
  ...
  assert.match(pieHtml, /#section-pie \.pie-choice\{display:grid;grid-template-columns:1\.1rem minmax\(0,1fr\);gap:\.45rem;align-items:flex-start;min-height:4\.1rem;height:100%;width:100%;min-width:0\}/);
  assert.match(pieHtml, /#section-pie \.pie-choice small\{display:-webkit-box;-webkit-line-clamp:1;-webkit-box-orient:vertical;overflow:hidden;line-height:1\.18;margin-top:\.08rem;font-size:\.74rem\}/);
});
