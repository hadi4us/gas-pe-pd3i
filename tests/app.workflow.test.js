...
test('PIE checkbox cards keep equal responsive dimensions', () => {
  ...
  assert.match(pieHtml, /#section-pie \.pie-choice small\{display:-webkit-box;-webkit-line-clamp:1;-webkit-box-orient:vertical;overflow:hidden;color:var\(--pd3i-muted\);line-height:1\.18;margin-top:\.08rem;font-size:\.74rem\}/);
});
